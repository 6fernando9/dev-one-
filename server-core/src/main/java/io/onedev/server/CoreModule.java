...
import io.onedev.server.traceability.CommitImpactListener;
...
import io.onedev.server.service.impl.DefaultAuditEventService;
...
public class CoreModule extends AbstractPluginModule {
	...
	protected void configure() {
		...
		bind(ConfigItemClassifier.class);
		...
		bind(AuditEventService.class).to(DefaultAuditEventService.class);
