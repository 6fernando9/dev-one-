...
public class ImportOption implements Serializable {
	...
	@Editable(order=200, description="Specify how to map YouTrack issue state to SCMDev issue state. "
			+ "Unmapped states will use the initial state in SCMDev.<br>"
	...
	@Editable(order=300, description="Specify how to map YouTrack issue fields to SCMDev. Unmapped fields will "
			...
			+ "<li>You may customize SCMDev issue fields in case there is no appropriate option here"
			+ "</ul>")
	...
	@Editable(order=300, description="Specify how to map YouTrack issue tags to SCMDev issue custom "
			+ "fields.<br>"
	...
	@Editable(order=400, description="Specify how to map YouTrack issue links to SCMDev issue links.<br>"
			+ "<b>NOTE: </b> You may customize SCMDev issue links in case there is no appropriate option here")
